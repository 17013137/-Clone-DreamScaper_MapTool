#include "stdafx.h"
#include "..\Public\LandScape.h"
#include "GameInstance.h"

CLandScape::CLandScape(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
...
void CLandScape::LateTick(_double TimeDelta)
{
...
HRESULT CLandScape::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CLandScape::SetUp_ConstantTable()
{
...
CLandScape * CLandScape::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CLandScape*	pInstance = new CLandScape(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CLandScape"));
...
{
	CLandScape*	pInstance = new CLandScape(*this);
